...
class AzurePronunciationService {
  ...
  Future<PronunciationScore> assessPronunciation({
    ...
    try {
      ...
      print('[AzurePronunciationService] POST $uri referenceText="$referenceText" bytes=${audioData.length}');
      ...
      print('[AzurePronunciationService] response status=${response.statusCode} body=${response.body}');
      ...
      print('[AzurePronunciationService] network error: $e');
      throw Exception('Network error: $e');
    } catch (e) {
      print('[AzurePronunciationService] error: $e');
      rethrow;
    }
  }
